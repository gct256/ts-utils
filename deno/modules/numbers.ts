 ...
 * @param defaultValue default value.
 */
export function floor(a: number, defaultValue = 0): number {
 ...
 * @param defaultValue default value.
 */
export function ceil(a: number, defaultValue = 0): number {
 ...
 * @param defaultValue default value.
 */
export function round(a: number, defaultValue = 0): number {
